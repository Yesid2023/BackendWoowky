...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $vet->givePermissionTo(['view_veterinary','view_veterinary_booking','view_veterinary_service','view_service','add_service','edit_service','delete_service','view_category','view_subcategory']);
        $groomer->givePermissionTo(['view_grooming','view_grooming_booking','view_grooming_service','view_service','add_service','edit_service','delete_service','view_category','view_subcategory']);
        $user->givePermissionTo(['view_booking']);
        $walker->givePermissionTo(['view_walking','view_walking_booking']);
        $boarder->givePermissionTo(['view_boarding','view_boarding_booking']);
        $trainer->givePermissionTo(['view_traning','view_training_booking' ]);
        $day_taker->givePermissionTo(['view_daycare','view_daycare_booking']);
