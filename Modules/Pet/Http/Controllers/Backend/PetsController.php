...
class PetsController extends Controller
{
    ...
    public function index_data()
    {
        ...
        return Datatables::of($query)
                        ...
                        ->editColumn('pet_count', function ($data) {
                           ...
                           return "<b><button type='button' data-assign-module='".$data->id."' data-assign-target='#pet-assign-form' data-assign-event='assign_pet' class='btn btn-secondray btn-sm rounded text-nowrap px-1' data-bs-toggle='tooltip' title='View all pet'> $pet_count</button> </b><button type='button' data-assign-module='".$data->id."' data-assign-target='#add-pet-form' data-assign-event='add_pet' class='btn btn-soft-primary btn-sm rounded text-nowrap px-2' data-bs-toggle='tooltip' title='Create New Pet'><i class='fa-solid fa-plus p-0'></i></button>";
                        })
    ...
    public function destroy($id)
    {
        ...
        // $message = Str::singular(Pets).' Deleted Successfully';
    ...
    public function pet_notes_list($id){
        ...
        $pet_notes=PetNote::where('pet_id',$id)->with('pet')->get();
