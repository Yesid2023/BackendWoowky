...
class WalkingController extends Controller
{
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        $query = Booking::query()->where('booking_type','walking')->branch()->with('user', 'walking', 'pet','employee','payment');
        ...
        return $datatable->eloquent($query)
            ...
            ->addColumn('action', function ($data) use ($module_name) {
                return view('booking::backend.walking.datatable.action_column', compact('module_name', 'data'));
            })
