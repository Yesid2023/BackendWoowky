  ...
  <form @submit="formSubmit">
    <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="form-offcanvas"
      ...
      <div class="offcanvas-body">
        ...
        <InputField class="col-md-12" type="number" :is-required="true" :label="$t('service.lbl_sessions')" placeholder=""
          v-model="sessions" :error-message="errors['sessions']" :error-messages="errorMessages['sessions']"></InputField>

        <InputField class="col-md-12" type="number" :is-required="true" :label="$t('service.lbl_price')" placeholder=""
...
const validationSchema = yup.object({
  ...
  sessions: yup.number().required('sessions is a required field'),
...
const { value: sessions } = useField('sessions')
