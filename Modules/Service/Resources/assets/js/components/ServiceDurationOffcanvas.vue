  ...
  <form @submit="formSubmit">
    <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="form-offcanvas"
      ...
      <div class="offcanvas-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label" for="hours">{{ $t('service.lbl_hours') }} <span
                    class="text-danger">*</span></label>
                <flat-pickr placeholder="Hours" id="hours" class="form-control" v-model="hours" :value="hours"
                  :config="config_hours"></flat-pickr>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label" for="minutes">{{ $t('service.lbl_minutes') }} <span
                    class="text-danger">*</span></label>
                <flat-pickr placeholder="Minutes" id="minutes" class="form-control" v-model="minutes" :value="minutes"
                  :config="config_minutes"></flat-pickr>
        ...
        <div class="col-md-12">
          <div class="form-group">
            <label class="form-label" for="modality">{{ $t('service.lbl_modality') }} <span
                class="text-danger">*</span></label>
            <select v-model="modality" :value="modality" name="action_type" class="form-control select2 col-12"
              id="quick-action-type" style="width:100%">
              <option value="single">{{ $t('service.single') }}</option>
              <option value="group">{{ $t('service.group') }}</option>
            </select>
            <span class="text-danger">{{ errors.modality }}</span>
          </div>
        </div>

        <InputField class="col-md-12" type="text" :is-required="true" :label="$t('service.lbl_price')" placeholder=""
          v-model="price" :error-message="errors['price']" :error-messages="errorMessages['price']"></InputField>
...
const { value: modality } = useField('modality')
